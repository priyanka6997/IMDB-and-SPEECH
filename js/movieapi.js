...
search.addEventListener('keyup' ,(e)=>{
    ...
    //when key press hide this text h1 and p
...
function SearchMovies(searchText){
    const imdbApi=`http://omdbapi.com/?s=${searchText}&apikey=7715f710`;
        ...
        .then((movieData) =>{
            ...
            for (let movie of movies) {
                ...
                <div>
                    ...
                    <h1>${movie.Title}</h1>
                    <p>${movie.Year}</p>
                    <a href="http://www.imdbapi.com/?i=${movie.imdbID}&apikey=7715f710" target="_blank">Movie Details</a>
                </div>
                `;
